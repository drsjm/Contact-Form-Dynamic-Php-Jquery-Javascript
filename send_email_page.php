...
<html lang="pt">
	<head>
		...
		<title>Send Dynamic E-mail By Daniel Rodrigues!</title>
...
<script src="https://www.google.com/recaptcha/api.js" async defer></script>
	...
	<body>
		<div class="container mt-3">
			<h1>Contact Form By Daniel Rodrigues!</h1>
        ...
        <div class="mb-3">
          <div class="g-recaptcha" data-sitekey="YOUR RECAPTCHA API SITE KEY"></div><br/>
                                    </div>
